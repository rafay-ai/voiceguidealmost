...
class VoiceGuideAPITester:
    ...
    def test_rating_system(self):
        ...
        try:
            ...
            self.log_test("Rate Item (5 stars)", success, details)
        except Exception as e:
            success = False
            self.log_test("Rate Item (5 stars)", False, f"Exception: {str(e)}")
    ...
    def test_combined_rating_search_flow(self):
        ...
        try:
            ...
            self.log_test("Rate Target Item (1 star)", success, details)
        except Exception as e:
            success = False
            self.log_test("Rate Target Item (1 star)", False, f"Exception: {str(e)}")
